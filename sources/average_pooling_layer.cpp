...
AveragePoolingLayer::AveragePoolingLayer(Random* rng, Size input_size, Size pool_size, int n_featmap)
    : AbstractLayer()
    , rng_(rng)
...
const Matrix& AveragePoolingLayer::forward_propagation(const Matrix& input) {
...
Matrix AveragePoolingLayer::back_propagation(const Matrix& error, double eta, double momentum) {
...
void AveragePoolingLayer::initialize() {
...
void AveragePoolingLayer::add_edge(int in, int out, int f) {
